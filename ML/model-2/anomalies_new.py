...
df_normal = pd.read_csv('normal_snmp_data_new.csv')
...
num_anomalies = int(0.05 * num_points / anomaly_duration)  # Number of anomalies needed to cover 5% of the dataset
...
df_anomalous.to_csv('anomalous_snmp_data_new.csv', index=False)